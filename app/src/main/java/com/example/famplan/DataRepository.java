...
public class DataRepository {
    ...
    public void deleteTask(String id) { tasks.removeIf(t -> t.getId().equals(id)); }
    ...
    public Task checkConflict(String date, String startTime) {
        for (Task t : tasks) {
            if (t.getDate().equals(date) && t.getStartTime().equals(startTime)) return t;
        }
        return null;
    }
}
